...
static const int64 MAX_MONEY = 1444000 * COIN; //total of 50 million coins (incl. PoS)	
...
static const uint256 hashGenesisBlockOfficial("0x000005045be4e23310c4f58b51f88158e250dc4cecf28a39137a4a4f8db227c6");
...
public:
    ...
    */
    ...
    /** Amount of Guineas spent by this transaction.
    ...
    /** Amount of Guineas coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at Guinea block #9689
        ...
        // Before Guinea block #9689 - old protocol
...
CBigNum GetBlockTrust() const
{
	...
	// Return nPoWTrust for the first 50 blocks
    if (pprev == NULL || pprev->nHeight < 50)
        return nPoWTrust;
